...
from .views import tipo_servicio_list, tipo_servicio_create, tipo_servicio_update, tipo_servicio_delete, crear_servicio, lista_servicios, eliminar_servicio, editar_servicio
